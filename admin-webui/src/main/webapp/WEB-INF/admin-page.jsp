            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="glyphicon glyphicon-th"></i> Data List
                    </h3>
                </div>
                <div class="panel-body">
                        ...
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input name="keyword" class="form-control has-success" type="text"
                                       placeholder="Input query criteria">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-warning">
                            <i class="glyphicon glyphicon-search"></i> Inquiry
                        </button>
                    </form>
                    ...
                    <a style="float: right;" href="admin/to/add/page.html" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add new</a>
                    <br>
                    <hr style="clear: both;">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <firenay:if test="${empty requestScope.pageInfo.list }">
                                <tr>
                                    <td colspan="6" align="center">Sorry! The data you are looking for was not found!</td>
                                </tr>
                            </firenay:if>
                            <firenay:if test="${!empty requestScope.pageInfo.list }">
