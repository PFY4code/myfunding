...
<script type="text/javascript">
        ...
        $("#saveRoleBtn").click(function () {
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if(result == "FAILED"){
                        layer.msg("Operation failed! Please check if the added role already exists")
                    }
                },
            ...
            $.ajax({
               "url": "role/remove/role/by/id/array.json",
                ...
                "success": function (response) {
                    ...
                    if(result == "FAILED"){
                        layer.msg("Delete failed" + response.message)
                    }
                },
                "error": function (response) {
                    layer.msg(response.status + " " + response.statusText)
    ...
    function fillAuthTree() {
        ...
        if(ajaxReturn.status != 200){
            layer.msg("Failed：" + ajaxReturn.status + "Statement: " + ajaxReturn.statusText);
            return ;
        }
        // 获取服务器返回的list
                    ...
                    <form class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input id="keywordInput" class="form-control has-success" type="text" placeholder="Input query criteria">
                            </div>
                        </div>
                        <button id="searchBtn" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> Inquiry</button>
                    </form>
                    <button id="batchRemoveBtn" type="button" class="btn btn-danger" style="float:right;margin-left:10px;" disabled="disabled"><i class=" glyphicon glyphicon-remove"></i> Delete</button>
                    <button id="showAddModalBtn" type="button" class="btn btn-primary" style="float:right;"><i class="glyphicon glyphicon-plus"></i> Add new</button>
                    <br>
                    <hr style="clear:both;">
