    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li class="active">Assgining Role</li>
            </ol>
                ...
                <div class="panel-body">
                    <form action="assign/do/role/assign.html" method="post" role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            <label for="selectUnAssignedRole">Unassigned Roles</label><br>
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            <label for="selectAssignedRole">Assigned Roles</label><br>
                            <%--  需要提交的数据 --%>
                        ...
                        <button id="submitBtn" style="width: 100px;" type="submit" class="btn btn-lg btn-success btn-block">Update</button>
                    </form>
                </div>
            </div>
        </div>
