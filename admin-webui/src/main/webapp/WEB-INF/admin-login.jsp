...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div>
                <a class="navbar-brand" href="admin/to/main/page.html" style="font-size: 32px;">MyFunding</a>
            </div>
        </div>
    </div>
</nav>
    ...
    <form action="security/do/login.html" method="post" class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" name="userName" class="form-control" id="inputUserName"
                   placeholder="Input Account" autofocus> <span
                class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-success has-feedback">
            <input type="password" name="userPswd" class="form-control" id="inputUserPass"
                   placeholder="Input Password" style="margin-top: 10px;"> <span
