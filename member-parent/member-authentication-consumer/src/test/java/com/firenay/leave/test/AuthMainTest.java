...
public class AuthMainTest {
	...
	@Test
	public void sendMessgeToGlobe(){
		DefaultProfile profile = DefaultProfile.getProfile("ap-southeast-1", "LTAI5t7hcWSmYvUt74xsniPq", "cGj8OtVg2MguGr8ar8qAB5bxKbohPR");
		...
		request.putQueryParameter("To", "13343322058");
		request.putQueryParameter("Message", "test");
		try {
