...
public class AssignHandler {
	...
	public ResultEntity<List<Integer>> saveRoleAuthRelationship(@RequestBody Map<String,List<Integer>> map){
		if(authService.saveRoleAuth(map) != 0){
			return ResultEntity.successWithoutData("Permissions modified successfully");
		}
		return ResultEntity.failed("Please check the relationship between roles and permissions! ");
	}
